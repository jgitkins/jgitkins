...
class OrganizeMemberServiceTest {
    ...
    void addOrganizeMember_savesWhenNotExists() {
        when(organizeMemberQueryPort.existsByOrganizeIdAndUserId(OrganizeId.of(1L), UserId.of(2L))).thenReturn(false);
    ...
    void addOrganizeMember_throwsWhenAlreadyExists() {
        when(organizeMemberQueryPort.existsByOrganizeIdAndUserId(OrganizeId.of(1L), UserId.of(2L))).thenReturn(true);

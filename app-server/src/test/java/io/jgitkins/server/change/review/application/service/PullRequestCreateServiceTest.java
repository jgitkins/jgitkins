...
class PullRequestCreateServiceTest {
    ...
    private final PullRequestCreateService service = new PullRequestCreateService(pullRequests, references, heads, results);
    ...
    void createResolvesRepositoryReadsBothHeadsPersistsAndMaps() {
        ...
        assertSame(result, service.createPullRequest(command));

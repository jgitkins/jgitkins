...
public class LoggingConfigurator implements ApplicationListener<ApplicationEnvironmentPreparedEvent> {
    ...
    private void configureCommonLoggers(LoggerContext loggerContext) {
        ...
        setLogger(loggerContext, "io.jgitkins.server.repository.infrastructure.persistence.mapper", Level.WARN);
        setLogger(loggerContext, "io.jgitkins.server.execution.infrastructure.persistence.mapper", Level.WARN);
        setLogger(loggerContext, "io.jgitkins.server.collaboration.infrastructure.persistence.mapper", Level.WARN);

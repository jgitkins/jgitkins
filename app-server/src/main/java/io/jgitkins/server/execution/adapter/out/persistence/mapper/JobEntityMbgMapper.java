package io.jgitkins.server.execution.adapter.out.persistence.mapper;

import io.jgitkins.server.execution.adapter.out.persistence.model.JobEntity;
import io.jgitkins.server.execution.adapter.out.persistence.model.JobEntityCondition;

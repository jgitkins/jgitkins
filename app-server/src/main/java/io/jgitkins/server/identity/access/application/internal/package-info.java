 ...
 * where it actually appears. Before that, {@code contract/result} held ten types, of which only
 * six were use-case output; the rest were these.
 *
 * <p><strong>These cross the outbound port</strong>, so an adapter implements against them and
 * changing one breaks that adapter:
 *
 * <ul>
 *   <li>{@link JwtAuthenticationResult}
 *   <li>{@link UserQueryResult}
 *   <li>{@link VerifiedOAuthIdentity}
 * </ul>
 *
